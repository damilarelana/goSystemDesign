...
IMAGE_NAME = "bento/ubuntu-16.04" # os image for vm i.e. using ubuntu-16-04 [to ensure that package installations have compatible versions e.g. ansible does not work with `ubuntu focal`
